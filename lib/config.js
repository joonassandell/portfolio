...
/**
 * Extra delay is to get heavier animation entities (e.g. Heros) smoother after
 * url changes and some page transition starts. Starting a heavy animation
 * at the same time when the url changes causes jaggering for some reason.
 * Check later if this could be fixed in some other way.
 */
export const extraDelay = 0; // 0.5
