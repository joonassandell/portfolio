...
export const Recommendations = () => (
  ...
  >
    ...
    <div className="Template-recommendations-content grid -gap:row:l grid-col grid-col:9@m">
      <div className="grid-col grid-col:11@m grid-col:9@xl">
        <Quote cite="https://www.linkedin.com/in/joonassandell/details/recommendations">
          <QuoteText>
            <p>
              Joonas is exceptionally talented individual with a rare
              combination of talent: designer and frontend developer who can do
              well crafted designs and also implement them with high quality. He
              is focused and hard working, yet as a person warm and approachable
              with good communication skills. My highest recommendation.
            </p>
          </QuoteText>
          <QuoteFooter>
            <Avatar
