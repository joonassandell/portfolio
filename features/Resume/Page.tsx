        ...
        <TemplateSection gridGap="m" gridRowGap="m" paddingTop={false}>
          <div className="Template-content grid-col grid-col:11@s grid-col:10@ grid-col:9@m -start:2@">
            ...
            <Text className="mb:l">
              <ul>
                <li>
                  ...
                  front-end together with the team including various features
                  such as real time carbon footprint calculation
                </li>
                <li>
                  Designed the application and its features including prototypes
                  and user flows with focus on detailed UX/UI, accessibility and
                  ease-of-use
                </li>
                <li>
                  Played an active role in enhancing overall direction of the
                  product and suggesting user-centric features based on
                  analytics
                </li>
                <li>
                  Built and designed{' '}
                  <Link href={getSitemap('biocode').url}>Biocode</Link>’s
                  end-to-end website including dark/light modes, CMS and Hubspot
                  integration among many other features
                </li>
                <li>
                  Designed, built and authored Biocode Design System including
                  brand assets such as logomarks, icons and product packaging
                  stamps
                </li>
                <li>
                  ...
                  Next.js web service to market the impact of Biocode for the
                  public audience
                </li>
                <li>
            ...
            <Text className="mb:l">
              <ul>
                ...
                <li>
                  ...
                  feedback from clients and end-users to build successful
                  products
                </li>
                <li>
                  Refreshed{' '}
            ...
            <Text className="mb:m">
              <ul>
                <li>
                  Built and curated valuable Exhibition Guide mobile app to help
                  visitors gain an enjoyable and insightful museum experiences
                </li>
                <li>
                  Built Museum Guide screen which featured maps, restaurant
                  menus and other museum information integrated to the website
                  CMS
                </li>
                <li>
                ...
                <li>
                  Developed and designed websites and posters for Museum Centre
                  Vapriikki, Moominvalley, Tampere Music Festivals and other
                  city sectors
                </li>
              </ul>
            </Text>
